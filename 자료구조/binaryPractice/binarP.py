...
file2 = open("/Users/bagjin-eun/Desktop/p/hello.txt","r")
for e in file2.readlines():
    print(e,end=" ")
file2.close()

file4 = open("/Users/bagjin-eun/Downloads/animal_dictionary.txt","r" ,encoding='cp949')
animal_dict = {}

for i in file4.readlines():
    i = i.strip()#문자열뒤에 개행문자를 날린다.
    datalist = i.split(",")# ' , ' comma를 기준으로 문자열을 자른다." 리스트의 형태로 반한한다.
    animal_dict[datalist[0]] = datalist[1]
print(animal_dict)
